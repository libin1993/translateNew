...
public class LTESendPackage {
    ...
    byte[] packageSequence;//包的序号2字节
    byte[]  packageSessionID;//对话ID2字节
    ...
    public byte[] getPackageContent() {
        ...
        //拷贝序号
        byte[] tempByte_Sequence = this.packageSequence;
        byteArray.append(tempByte_Sequence, 0, tempByte_Sequence.length);

        //拷贝SessionID
        byte[] tempByte_SessionID = this.packageSessionID;
    ...
    public String toString() {
        return "LTESendPackage{" +
                ...
                ", packageSequence=" + Arrays.toString(packageSequence) +
                ", packageSessionID=" + Arrays.toString(packageSessionID) +
